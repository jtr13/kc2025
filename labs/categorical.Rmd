...
ggplot(food_world_cup, aes(knowledge)) +
    ...
    labs(title = "Knowledge level of respondents") +
    theme_bw(16) +
...
ggplot(df, aes(x = nMales, y = Freq)) +
  ...
  labs(title ="19c Saxony: # of males in families with 12 children", x = "number of male children") +
  theme_bw(14) +
  theme(panel.grid.major.x = element_blank())
```
...
ggplot(africa, aes(x = GDP, y = fct_reorder(COUNTRY, GDP))) +
  ...
  labs(title ="Africa: GDP per capita, 2012", y = NULL) +
...
ggplot(belts, aes(x = fatalities, y = fct_reorder2(state, year == 1997, fatalities,
  ...
  geom_point() +
  labs(title ="# of fatalities per million traffic miles", y = NULL) +
  theme_linedraw()
```
